...
if is_mobile:
    ...
    with row1[1]: 
        st.markdown(f"""<div style="background-color: #262540; color: white; padding: 20px; border-radius: 12px; text-align: left; min-height: 118px;width: 165px;margin-left: 200px; margin-bottom: 5px;margin-top: 0px;"> 
